...
export function ProjectChart() {
  ...
  const taskData = [
    { name: TASK_STATUS.todo.labelPlural, value: taskStats.todo },
    { name: TASK_STATUS["in-progress"].labelPlural, value: taskStats.inProgress },
    { name: TASK_STATUS.review.labelPlural, value: taskStats.review },
    { name: TASK_STATUS.completed.labelPlural, value: taskStats.completed },
  ].filter((item) => item.value > 0)
